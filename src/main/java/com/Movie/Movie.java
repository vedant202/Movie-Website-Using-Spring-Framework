...
public class Movie{
	...
	public String toString() {
		return "Movie [adult=" + adult + ", original_language=" + original_language + ", original_title="
				+ original_title + ", release_date=" + release_date + ", title=" + title + ", vote_average="
				+ vote_average + ", vote_count=" + vote_count + ", overview=" + overview + ", popularity=" + popularity
